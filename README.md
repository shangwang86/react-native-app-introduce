# react-native-app-introduce
react-native-app-introduce is a react native component implementing a parallax effect welcome page using base on [react-native-swiper](https://github.com/leecade/react-native-swiper) , similar to the one found in Google's app like Sheet, Drive, Docs...

# react-native-app-introduce Screen Capture

[Example code](https://github.com/shangwangzhang/react-native-app-introduce/tree/master/Example)
...
```bash
$ npm install react-native-app-introduce --save
```
...
import AppIntro from 'react-native-app-introduce';
...
| onSkipBtnClick | (index) => {}     |                         | function to call when the Skip button click, also go to last page                                                                                                                                                                                                                                                                                                                      |
...
| goLastPage | bool   | false | a boolen going to the last page when the skip button is clicked |
